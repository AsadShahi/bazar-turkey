            ...
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              >
                ...
                <svg
                  ...
                  className="w-4 h-4 text-white dark:text-slate-700 block peer-checked:hidden"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
              ...
              <span className="text-sm font-bold px-1 text-gray-700 dark:text-white">
                ذخیره اطلاعات مسافر
              </span>
            </div>
