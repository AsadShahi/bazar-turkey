...
export default function Footer() {
    ...
    return (
        ...
        <footer className="flex flex-col justify-center bg-white  dark:bg-[#3A3C42] dark:text-white text-black py-6">
            ...
            {/* empty Background */}
            <div className='flex justify-end  bg-[#F6F6F6]   dark:bg-[#25272C]  translate-y-6 md:translate-y-12 py-6 md:py-20 md:pl-32  z-2'>
                ...
                <div className="container order-2 sm:order-3 md:order-2 mx-auto px-4 py-6">
                    <div className="grid grid-cols-1 text-[#4D4D4D] dark:text-white sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="min-w-[200px]">
                            <h2
                                className="md:hidden sm:block dark:bg-[#383A40] flex items-center justify-between py-3 rounded-md px-2 bg-[#F6F6F6] text-base font-bold mb-4 cursor-pointer sm:mb-2 sm:block transition-all duration-500 ease-in-out"
                            ...
                            <ul
                                className={`space-y-2 ${quickAccessOpen ? 'block' : 'hidden'} sm:block sm:space-y-1 transition md:gap-[12px]`}
                            >
                        ...
                        <div className="min-w-[200px] sm:w-full">
                            <h2
                                className="md:hidden sm:block -mt-5 dark:bg-[#383A40] flex items-center justify-between py-3 rounded-md px-2 bg-[#F6F6F6] text-base font-bold mb-4 cursor-pointer sm:mb-2 sm:block"
                            ...
                            <ul
                                className={`space-y-2 ${importentLinksOpen ? 'block' : 'hidden'} sm:block md:block sm:w-full md:w-auto md:gap-[12px]`} // Full width on mobile (sm) and auto width on larger screens (md+)
                            >
                                <li><Link href="">رهگیری مرسولات</Link></li>
                                <li><Link href="">سوالات متداول</Link></li>
                                <li><Link href="">قوانین و مقررات</Link></li>
                        ...
                        <div className="block md:hidden min-w-[200px] sm:w-full">
                            ...
                            <div
                                className={`dark:bg-[#383A40] bg-[#F6F6F6] rounded-md p-5 ${isSocialOpen ? 'block' : 'hidden'} sm:block`}
                            >
                ...
                <div className='container mx-auto mt-2 px-4 py-5'>
                    <div className='flex justify-between items-center text-white'>
                        ...
                        <div className="hidden md:flex space-x-4 items-center">
                            <Link href={''}>
                                <FaFacebook className="text-blue-500 dark:text-[#fff]  mx-3 dark:bg-[#404248] bg-[#F6F6F6] p-1 rounded-sm" size={30} />
                            </Link>
                            <Link href={''}>
                                <FaTelegram className="text-blue-700 dark:text-[#fff] dark:bg-[#404248] bg-[#F6F6F6] p-1 rounded-sm" size={30} />
                            </Link>
                            <Link href={''}>
                                <FaWhatsapp className="text-green-700 dark:text-[#fff] dark:bg-[#404248] bg-[#F6F6F6] p-1 rounded-sm" size={30} />
                            </Link>
                            <Link href={''}>
                                <FaInstagram className="text-pink-700 dark:text-[#fff] dark:bg-[#404248] bg-[#F6F6F6] p-1 rounded-sm" size={30} />
                            </Link>
                        </div>
